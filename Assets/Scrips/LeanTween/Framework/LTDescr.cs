...
public class LTDescr
{
	...
	*/
    ...
    public LTDescr setGraphicColor()
    {
        this.type = TweenAction.GRAPHIC_COLOR;
        this.initInternal = () =>
        {
            this.uiGraphic = trans.GetComponent<UnityEngine.UI.Graphic>();
            this.setFromColor(this.uiGraphic != null ? this.uiGraphic.color : Color.white);
        };
        this.easeInternal = () =>
        {
            newVect = easeMethod();
